...
class SitePagesSeeder extends Seeder
{
    ...
    public function run()
    {
    	DB::table('site_pages')->insert([
            ...
            'noindex' => TRUE,
            'html_content' => <<<EOT
<p class="lead text-dark font-weight-bold">Ultimate Guide to CDA Structured Interview: Tips & Proven Strategies to Help You Prepare & Ace Your CDA Interview</p>

<p class="lead text-dark font-weight-bold">Overview:</p>
<ul>
    ...
    <li><a href="#">How to prepare for your CDA Interview</a></li>
    <li><a href="#">Sample CDA interview questions</a></li>
    <li><a href="#">BeMo CDA-structured interview prep program</a></li>
    <li><a href="#">Contact us</a></li>
</ul>

<br>
<p class="lead text-dark font-weight-bold">What is the purpose of the dental school interview?</p>
...
<p class="lead text-dark font-weight-bold">History, rationale, and the structure of the CDA interview</p>
...
<br>
<p class="lead text-dark font-weight-bold">Types of Questions</p>
...
<p class="lead text-dark font-weight-bold">The Seven Competencies</p>
<ol>
...
<p class="lead text-dark font-weight-bold">Structure of the CDA interview</p>
...
<p class="lead text-dark font-weight-bold">Reference:</p>
...
<div class="row">
    <ul>
        <li>Toll Free: 1-855-900-BeMo (2366)</li>
        <li>Email: info@bemoacademicconsulting.com</li>
    </ul>
</div>
EOT
		]);
